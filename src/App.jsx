...
export default function App() {
  ...
  const [examCategoriesList, setExamCategoriesList] = useState([]); // NEW: Tracks predefined exam categories
  ...
  const [newExamCategoryName, setNewExamCategoryName] = useState(''); // NEW: For creating exam categories
        ...
        <div className="min-h-screen">
          ...
          <main className="container flex-col" style={{ flex: 1 }}>
            ...
            <div className="question-box">
              <p style={{ fontSize: '1.25rem', fontWeight: 500, marginBottom: currentQuestion?.imageUrl ? '1rem' : '0' }}>
              ...
              {(Array.isArray(currentQuestion?.options) ? currentQuestion.options : []).map((option, optIdx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="flex-1"><LatexText text={option?.text || ''} /></span>
            ...
            {examMode === 'study' && hasAnsweredCurrent && (
              <div className="card mb-8" style={{ background: '#fffbeb', borderColor: '#fde68a' }}>
                ...
                <p style={{ color: '#92400e' }}><LatexText text={currentQuestion?.explanation || 'No explanation provided.'} /></p>
